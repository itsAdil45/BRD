...
const auctionItems = [
  ...
  },
  {
    ...
    lotNo: "Lot # 25896742",
    countdown: "2024-10-23 12:00:00",
    title: "Genesis motors pioneering on tomorrow's drive.",
    price: "$4,648",
    btnText: "Notify Me",
    delay: "200ms",
  },
  ...
  },
  {
    ...
    lotNo: "Lot # 25896742",
    countdown: "2024-10-23 12:00:00",
    title: "Titan motors build to conquer every mile cars.",
    price: "$6,867",
    btnText: "Notify Me",
    delay: "600ms",
  },
...
const CarAuctionSidebar = () => {
  ...
  const highestBidding = [
    {
      img: "/assets/img/inner-pages/highest-bidding-img1.jpg",
      title: "Poutsicle Hydratingani Stain offering.",
      price: "$4,648",
    },
    {
      img: "/assets/img/inner-pages/highest-bidding-img2.jpg",
      title: "Heritage Had Curating Watch.",
      price: "$2,458",
    },
    {
      img: "/assets/img/inner-pages/highest-bidding-img3.jpg",
      title: "Art decorat bronze sculpture.",
      price: "$2,878",
    },
  ];
          ...
          <div className="row gy-5">
            ...
            <div className="col-xl-3 order-xl-1 order-2">
              <div className="auction-sidebar">
                ...
                {/* Highest Bidding Widget */}
                <div className="single-widget">
                  <h5 className="widget-title">Highest Bidding</h5>
                  {highestBidding.map((item, i) => (
                    <div
                      key={i}
                      className={`highest-bidding-widget ${i < highestBidding.length - 1 ? "mb-20" : ""}`}
                    >
            ...
            <div className="col-xl-9 order-xl-2 order-1">
              ...
              <div className="list-grid-product-wrap column-1-wrapper">
                <div className="row g-4 mb-60">
                  {auctionItems.map((item) => (
                    <div
                      key={item.id}
                      className="col-12 item wow animate fadeInDown"
                      data-wow-delay={item.delay}
                      data-wow-duration="1500ms"
                    >
                      <div className="auction-card style-2 list-card-horizontal">
                        {/* Image Section */}
                        <div className="auction-card-img-wrap list-card-img-wrap">
                              ...
                              <>
                                ...
                                {item.lotNo && (
                                  <div className="code-no">
                                    <span className="code">{item.lotNo}</span>
                                  </div>
                                )}
                              </>
                            )}
                          ...
                          <div className="countdown-timer">
                            <ul data-countdown={item.countdown}>
                        ...
                        {/* Content Section */}
                        <div className="auction-card-content list-card-content">
                          <h6>
