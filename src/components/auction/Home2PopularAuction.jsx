    ...
    <>
      <div className="home2-popular-auction-section mb-110">
        <div className="container-fluid">
          <div
            className="home2-popular-auction-wrap "
            style={{ display: "block" }}
          >
            <div
              className="popular-auction-slider-area"
                      ...
                      <diSwiperSlidev className="swiper-slide">
                        ...
                        <div className="auction-card style-2">
                          ...
                          <div className="auction-card-content">
                            <h6>
                              <Link href="/product-detail">
                                Velocity Visions Precision Performance.
                              </Link>
                            </h6>
                            <div className="price-and-code-area">
                              <div className="price">
