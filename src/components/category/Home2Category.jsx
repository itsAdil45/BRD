    ...
    <>
      <div className="home2-category-section mb-110" id="category-section">
        <div className="container">
          ...
          <div
            className="category-slider-area mb-50 wow animate fadeInUp"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
            <div className="row">
                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="category-card2">
                        ...
                        <div className="category-content">
                          <h5>
                            <Link href="/car-auciton/auction-sidebar">
                              Mercedes
                            </Link>
                          </h5>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="category-card2">
                        <div className="icon">
                          <img
                            src="../assets/img/home2/icon/toyota-logo.svg"
                            alt=""
                          />
                        </div>
                        <div className="category-content">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="category-card2">
                        <div className="icon">
                          <img
                            src="../assets/img/home2/icon/bmw-logo.svg"
                            alt=""
                          />
                        </div>
                        <div className="category-content">
                          <h5>
                            <Link href="/car-auciton/auction-sidebar">BMW</Link>
                          </h5>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="category-card2">
                        <div className="icon">
                          <img
                            src="../assets/img/home2/icon/tesla-logo.svg"
                            alt=""
                          />
                        </div>
                        <div className="category-content">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="category-card2">
                        <div className="icon">
                          <img
                            src="../assets/img/home2/icon/hyundai-logo.svg"
                            alt=""
                          />
                        </div>
                        <div className="category-content">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="category-card2">
                        <div className="icon">
                          <img
                            src="../assets/img/home2/icon/nissan-logo.svg"
                            alt=""
                          />
                        </div>
                        <div className="category-content">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="category-card2">
                        <div className="icon">
                          <img
                            src="../assets/img/home2/icon/honda-logo.svg"
                            alt=""
                          />
                        </div>
                        <div className="category-content">
          ...
          >
            <div className="col-lg-12 d-flex justify-content-center">
              <Link className="view-button" href="/categories">
                View All Category
