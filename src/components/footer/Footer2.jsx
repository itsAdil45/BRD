          ...
          <div className="container">
            ...
            {/* <div className="footer-bottom">
              <div className="copyright-area">
                <p>
                  ©Copyright 2024 <Link href="/">Probid</Link> | Design By{" "}
              ...
              <div className="footer-bottom-right">
                <ul>
                  <li>
                    <Link href="/car-auction/support-center">
                      Support Center
                    </Link>
                  </li>
                  <li>
                    <Link href="/car-auction/terms-condition">
                      Terms &amp; Conditions
                    </Link>
                  </li>
                  <li>
                    <Link href="/car-auction/privacy-policy">
                      Privacy Policy
                    </Link>
                  </li>
                </ul>
